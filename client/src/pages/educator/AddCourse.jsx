...
const AddCourse = () => {
 ...
 const handleSubmit = async (e) => {
  ...
  return (
    <div className='h-screen overflow-y-auto flex justify-start px-6 md:px-16 py-8'>
      
      <form  onSubmit={handleSubmit} className='w-full max-w-2xl flex flex-col gap-5 text-gray-600'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <input
            ...
            className='px-3 py-2 border border-gray-400 rounded outline-none'
          />
        </div>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <div
            ref={editorRef}
            className='bg-white border rounded h-[140px]'
          />
        </div>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 gap-4 items-end'>
          ...
          <div className='flex flex-col gap-1'>
            ...
            <label
              ...
              className='flex items-center gap-3 border border-dashed border-gray-400 px-3 py-2 rounded cursor-pointer'
            >
              <img
                src={assets.file_upload_icon}
                alt=""
                className='w-8 h-8 bg-blue-500 p-1.5 rounded'
              />
                  ...
                  {chapter.chapterContent.map((lecture, lectureIndex)=>(
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      ...
                      <span>{lectureIndex + 1} {lecture.lectureTitle} - {lecture.lectureDuration}
                        ...
                        target="_blank" className='text-green-500'>Link</a> - {lecture.isPreviewFree ? 

  ...
  return courseData ? (
    ...
    md:px-36 px-8 md:pt-30 pt-20 text-left'>
        ...
        text-course-details-heading-small font-semibold text-gray-800'>{courseData.courseTitle}</h1>
          ...
          <div className='flex itms-center space-x-2 pt-3 pb-1 text-sm'>
          ...
          <p className='text-sm'>Course by <span className='text-violet-600 underline'>{courseData.educator.name}</span></p>

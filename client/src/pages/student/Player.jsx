        ...
        <h2 className='text-xl font-semibold'>Course Structure</h2>
         ...
         <div className='pt-5'>
                    ...
                    <div className='flex items-center gap-2 py-3 mt-10'>
                      ...
                      <Rating initialRting={initialRating} onRate={handleRate}/>
                    </div>
      </div>
        ...
        {playerData ? (
          <div>
            ...
            <div className='flex justify-between items-center mt-1'>
              ...
              <button onClick={()=> markLectureAsCompleted(playerData.lectureId)} className='text-green-600'>
